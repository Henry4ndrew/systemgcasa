...
<?php include 'forms/addProduct_almacen.php' ?>
<?php include 'forms/editCantProduct_almacen.php' ?>

<div class="panel">
    <h3 class="b-naranja f-white pad-left20">Stock de productos</h3>
    <div class="b-azul pad20 cont-elemts">
        ...
        <button class="btn-load orange" onclick="mostrarFormBuscador('formAddProdAlmacen','lista-prod-agregados')"><span>Agregar producto</span></button>
    </div>
</div>
...
<tbody>
       ...
       <?php foreach ($productos as $fila):
        ...
        ?>
            <tr>
                ...
                <td>
                    <form action="actions/eliminar_cantidadAlmacen.php" class="formFunctions" method="post" onsubmit="return confirm('¿Estás seguro de que deseas eliminar esta cantidad del almacén?');">
    ...
    <?php else: ?>
        <tr>
            <td colspan="7">No hay productos en el almacén</td>
        </tr>
    <?php endif; ?>
</tbody>
</table>
