...
<form action="actions/addCant_product_tienda.php" method="post" class="formStyle b-azul grande" id="formAddProdAlmacenTienda">
    <div class="cabecera">
      <h2>Agregar productos al almacén - Tienda</h2>
